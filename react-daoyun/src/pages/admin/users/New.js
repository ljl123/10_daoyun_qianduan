        ...
        if (id) {
            ...
            getUserInfo(params).then((res) => {
                if (res.result_code == 200) {
                    ...
                    console.log('sucesess read data');
    ...
    const onFinish = values => {
        ...
        if (props.match.params.id) {
            ...
            */
            let type_0 = 2;
            //let type_1 = 4;
            AddUserApi(token, values.phone, values.count_type, values.email, values.name).then((res) => {
                if (res.data.result_code === '200') {
                    console.log("成功添加");
                    ...
                    message.success(res.data.result_desc);
                }
            })
        }
    };
    ...
    return (
        <Card title="用户编辑"
            ...
            <Form {...layout} form={form} name="userEdit" onFinish={onFinish} validateMessages={validateMessages}
                ...
                <Form.Item name="count_type" label="角色" rules={[{ required: true, message: "请选择角色" }]}>
                    <Select
                    >
